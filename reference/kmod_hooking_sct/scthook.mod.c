...
__attribute__((section("__versions"))) = {
	...
	{ 0xed99881, __VMLINUX_SYMBOL_STR(__module_address) },
	{ 0x328253a5, __VMLINUX_SYMBOL_STR(vmalloc_to_page) },
};
